...
\input{acronyms}                          % makeglossaries main in der cmd ausführen
...
\include{chapters/implemtierung}
\include{chapters/testen}
\include{chapters/ZusammenfassungundErfahrungen}
