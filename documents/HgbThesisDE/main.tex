...
% \documentclass[bachelor,german,smartquotes,authoryearbrackets]{hgbthesis}
...
\include{acronyms}                          % makeglossaries main in der cmd ausführen
...
\include{chapters/DasDerzeitigeThreadmodell}
\include{chapters/projectLoom}
\include{chapters/messungen}
